...
public class Stopwords {
    ...
    private static HashSet<String> stopwords = new HashSet<>(Arrays.asList("a", "about", "above", "after", "again",
    ...
    /**
     * Checks if the given word in English is a stopword.
     * 
     * @param word word to check
     * @return true if the supplied word is a stopword
     */
